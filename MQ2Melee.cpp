...
long      GemsMax        = 13;              // Maximum Number of Gems
...
synergy10 = { 35043  ,3 },        // disc: Shadewalker's Synergy lv 96 MnkRoF
...
feign_n7 = { 31616  ,5 },        // spell: Conscripted Sacrifice lv 99 Nec VoA
...
bloodlust19 = { 60781  ,3 },        //Disc: Shared Atavism - Level 115 - TOV
bloodlust20 = { 60782  ,3 },
bloodlust21 = { 60783  ,3 },
...
joltber29 = { 60772  ,3 },        // Disc: Jarring Shock - Level 114 - TOV
joltber30 = { 60773  ,3 },
joltber31 = { 60774  ,3 },
...
vigber27 = { 68162  ,3 };        // Disc: Rending Axe Throw  Rk. II
#pragma endregion Updated to LS
...
DECLARE_ABILITY_OPTION(pCHFOR, "challengefor", "[ON/OFF]?", "${If[${Me.Spell[Challenge for Honor].ID} || ${Me.Spell[trial for honor].ID} || ${Me.Spell[charge for honor].ID} || ${Me.Spell[challenge for power].ID} || ${Me.Spell[trial for power].ID} || ${Me.Spell[charge for honor].ID} || ${Me.Spell[confrontation for power].ID} || ${Me.Spell[confrontation for honor].ID} || ${Me.Spell[Provocation for honor].ID} || ${Me.Spell[Provocation for power].ID} || ${Me.Spell[Demand for Power].ID} || ${Me.Spell[Demand for Honor].ID} || ${Me.Spell[Impose for Power].ID} || ${Me.Spell[Impose for Honor].ID} || ${Me.Spell[Refute for Power].ID} || ${Me.Spell[Refute for Honor].ID} || ${Me.Spell[Protest for Power].ID} || ${Me.Spell[Protest for Honor].ID} || ${Me.Spell[Parlay for Power].ID} || ${Me.Spell[Parlay for Honor].ID} || ${Me.Spell[Petition for Honor].ID} ||  ${Me.Spell[Petition for Power].ID},1,0]}", "${If[${meleemvi[plugin]} && ${meleemvi[aggro]} && (${Me.Spell[challenge for honor].ID} || ${Me.Spell[trial for honor].ID} || ${Me.Spell[charge for honor].ID} || ${Me.Spell[challenge for power].ID} || ${Me.Spell[trial for power].ID} || ${Me.Spell[charge for honor].ID} || ${Me.Spell[confrontation for power].ID} || ${Me.Spell[confrontation for honor].ID} || ${Me.Spell[Provocation for honor].ID} || ${Me.Spell[Provocation for power].ID} || ${Me.Spell[Demand for Power].ID} || ${Me.Spell[Demand for Honor].ID} || ${Me.Spell[Impose for Power].ID} || ${Me.Spell[Impose for Honor].ID} || ${Me.Spell[Refute for Power].ID} || ${Me.Spell[Refute for Honor].ID} || ${Me.Spell[Protest for Power].ID} || ${Me.Spell[Protest for Honor].ID} || ${Me.Spell[Parlay for Honor].ID} || ${Me.Spell[Parlay for Power].ID} ||  ${Me.Spell[Petition for Honor].ID} || ${Me.Spell[Petition for Power].ID}),1,0]}");
...
DECLARE_ABILITY_OPTION(pFIELD, "fieldarm", "[#] Endu% Above? 0=Off", "${If[${Me.CombatAbility[Field Armorer]} || ${Me.CombatAbility[Field Armorer Rk. II]} || ${Me.CombatAbility[Field Armorer Rk. III]} || ${Me.CombatAbility[Field Outfitter]} || ${Me.CombatAbility[Field Outfitter Rk. II]} || ${Me.CombatAbility[Field Outfitter Rk. III]} || ${Me.CombatAbility[Field Defender]} || ${Me.CombatAbility[Field Defender Rk. II]} || ${Me.CombatAbility[Field Defender Rk. III]} || ${Me.CombatAbility[Field Guardian]} || ${Me.CombatAbility[Field Guardian Rk. II]} || ${Me.CombatAbility[Field Guardian Rk. III]} || ${Me.CombatAbility[Field Protector]} || ${Me.CombatAbility[Field Protector Rk. II]} || ${Me.CombatAbility[Field Protector Rk. III]} || ${Me.CombatAbility[Field Champion]} || ${Me.CombatAbility[Field Champion Rk. II]} || ${Me.CombatAbility[Field Champion Rk. III]} || ${Me.CombatAbility[Paragon Champion]} || ${Me.CombatAbility[Paragon Champion Rk. II]} || ${Me.CombatAbility[Paragon Champion Rk. III]},20,0]}", "${If[${meleemvi[plugin]} && (${Me.CombatAbility[Field Armorer]} || ${Me.CombatAbility[Field Armorer Rk. II]} || ${Me.CombatAbility[Field Armorer Rk. III]} || ${Me.CombatAbility[Field Outfitter]} || ${Me.CombatAbility[Field Outfitter Rk. II]} || ${Me.CombatAbility[Field Outfitter Rk. III]} || ${Me.CombatAbility[Field Defender]} || ${Me.CombatAbility[Field Defender Rk. II]} || ${Me.CombatAbility[Field Defender Rk. III]} || ${Me.CombatAbility[Field Guardian]} || ${Me.CombatAbility[Field Guardian Rk. II]} || ${Me.CombatAbility[Field Guardian Rk. III]} || ${Me.CombatAbility[Field Protector]} || ${Me.CombatAbility[Field Protector Rk. II]} || ${Me.CombatAbility[Field Protector Rk. III]} || ${Me.CombatAbility[Field Champion]} || ${Me.CombatAbility[Field Champion Rk. II]} || ${Me.CombatAbility[Field Champion Rk. III]} || ${Me.CombatAbility[Paragon Champion]} || ${Me.CombatAbility[Paragon Champion Rk. II]} || ${Me.CombatAbility[Full Moon's Champion]} || ${Me.CombatAbility[Full Moon's Champion Rk. II]} || ${Me.CombatAbility[Full Moon's Champion Rk. III]} || ${Me.CombatAbility[Field Bulwark]} || ${Me.CombatAbility[Field Bulwark Rk. II]} || ${Me.CombatAbility[Field Bulwark Rk. III]}),1,0]}");
...
#pragma region Monk - Class 7
DECLARE_ABILITY_OPTION(pCFIST, "cloud", "[#] Endu% Above? 0=Off", "${If[${Me.CombatAbility[Cloud of Fists]} || ${Me.CombatAbility[Cloud of Fists Rk. II]} || ${Me.CombatAbility[Cloud of Fists Rk. III]} || ${Me.CombatAbility[Phantom Partisan]} || ${Me.CombatAbility[Phantom Partisan Rk. II]} || ${Me.CombatAbility[Phantom Partisan Rk. III]} || ${Me.CombatAbility[Phantom Pummeling]} || ${Me.CombatAbility[Phantom Pummeling Rk. II]} || ${Me.CombatAbility[Phantom Pummeling Rk. III]} || ${Me.CombatAbility[Phantom Fisticuffs]} || ${Me.CombatAbility[Phantom Fisticuffs Rk. II]} || ${Me.CombatAbility[Phantom Fisticuffs Rk. III]},20,0]}", "${If[${meleemvi[plugin]} && (${Me.CombatAbility[Cloud of Fists]} || ${Me.CombatAbility[Cloud of Fists Rk. II]} || ${Me.CombatAbility[Cloud of Fists Rk. III]} || ${Me.CombatAbility[Phantom Partisan]} || ${Me.CombatAbility[Phantom Partisan Rk. II]} || ${Me.CombatAbility[Phantom Partisan Rk. III]}|| ${Me.CombatAbility[Phantom Pummeling]} || ${Me.CombatAbility[Phantom Pummeling Rk. II]} || ${Me.CombatAbility[Phantom Pummeling Rk. III]} || ${Me.CombatAbility[Phantom Fisticuffs]} || ${Me.CombatAbility[Phantom Fisticuffs Rk. II]} || ${Me.CombatAbility[Phantom Fisticuffs Rk. III]}),1,0]}");
...
void Configure() {
    ...
    case  Shadowknight: // SHD
        ...
        AbilityFind(&idSTEELY, &steely26, &steely25, &steely24, &steely23, &steely22, &steely21, &steely20, &steely19, &steely18, &steely17, &steely16, &steely15, &steely14, &steely13, &steely12, &steely11, &steely10, &steely9, &steely8, &steely7, &steely6, &steely5, &steely4, &steely3, &steely2, &steely1, 0);
        AbilityFind(&idWITHSTAND, &withstand27, &withstand26, &withstand25, &withstand24, &withstand23, &withstand22, &withstand21, &withstand20, &withstand19, &withstand18, &withstand17, &withstand16, &withstand15, &withstand14, &withstand13, &withstand12, &withstand11, &withstand10, &withstand9, &withstand8, &withstand7, &withstand6, &withstand5, &withstand4, &withstand3, &withstand2, &withstand1, 0);
        break;
    case  Monk: // MNK
        MonkClass = true;
