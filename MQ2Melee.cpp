...
//                          | 2023-12-15: Updated by FelisMalum - Added ramaining spells/discs for LS, updated potion list
//
//=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=//
...
steely26 = { 66343  ,5 },        // spell: Unwavering Stance Rk. III
...
vigber22 = { 68160  ,3 },        // Disc: Rending Axe Throw  Lv 123 Ber ToL
vigber23 = { 68161  ,3 },        // Disc: Rending Axe Throw  Rk. II
vigber24 = { 68162  ,3 };        // Disc: Rending Axe Throw  Rk. II
#pragma endregion Updated to LS
